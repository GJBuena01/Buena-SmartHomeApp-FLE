...
export default function HomeScreen({ navigation }: Props) {
    return (
        <ScrollView style={styles.container}>
            <Feather name="home" size={80} color="black" style={{alignSelf: 'center', marginTop: 20, marginBottom: 10}} />
            <Text style={styles.title}>Smart Home Dashboard</Text>

            <Text style={styles.welcome}> Welcome, Gab! </Text>

            <View style={styles.card}> 
                <View style={styles.row}>
                    <View style={styles.pane}>
                        <MaterialCommunityIcons name="lightbulb" size={50} color="#ccd527" />
                        <Text style={styles.paneText}>Light</Text>
                        <Text style={styles.paneStatus}>ON</Text>
                    </View>

                    <View style={styles.pane}>
                        <MaterialCommunityIcons name="fan" size={50} color="#13a55a" />
                ...
                <View style={styles.row}>
                    <View style={styles.pane}>
                        <MaterialCommunityIcons name="snowflake" size={50} color="#1330a5" />
                        <Text style={styles.paneText}>AC</Text>
                        <Text style={styles.paneStatus}>ON</Text>
                    </View>

                    <View style={styles.pane}>
                        <MaterialCommunityIcons name="lock" size={50} color="#a51313" />
